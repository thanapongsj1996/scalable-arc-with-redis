...
func Setup(db *gorm.DB) error {
	...
	db.Exec("CREATE TABLE IF NOT EXISTS members (id VARCHAR(50) NOT NULL, username VARCHAR(500) NOT NULL, register_order INT NOT NULL, is_active INT NOT NULL, CONSTRAINT PK_members PRIMARY KEY (id));")
